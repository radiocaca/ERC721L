 ...
 */
abstract contract ERC721Lockable is ERC721Upgradeable, IERC721Lockable {
    ...
    function lockFrom(
        ...
        require(expired > block.timestamp, "ERC721L: expired time must be greater than current block number");
        require(!isLocked(tokenId), "ERC721L: token is locked");
    ...
    function unlockFrom(address from, uint256 tokenId) public virtual override {
        ...
        require(ERC721Upgradeable.ownerOf(tokenId) == from, "ERC721L: unlock from incorrect owner");
    ...
    function _lock(
        ...
        require(ERC721Upgradeable.ownerOf(tokenId) == from, "ERC721L: lock from incorrect owner");
    ...
    function _safeLockMint(
        ...
        require(expired > block.timestamp, "ERC721L: lock mint for invalid lock block number");
